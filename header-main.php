...
<body>
    ...
    <header class="header-main" style="background-image: url(<?php bloginfo('template_url') ?>/assets/img/header.png);">
        <div class="container">
            ...
            <div class="header-main__offer">
                ...
                <div class="header-main__offer-title" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">Котлы <span>отопления</span> для частного дома, торгового или производственного объекта</div>
